...
//  Color _mainColor = Color(0xFFFF4E6A);
  ...
  Color _buttonColor = Color(0xffFFFFFF);
  Color _scaffoldColor = Color(0xFF233558);
  Color _textColor = Color(0xffFFFFFF);
  Color _greenColor = Color(0xff009B66);
  Color _skyColor = Color(0xff6192F4);
  Color _darkscaffoldColor = Color(0xff1D2E51);

  Color skyColor(double opacity) {
    return this._skyColor.withOpacity(opacity);
  }
  ...
  Color darkscaffoldColor(double opacity) {
    return this._darkscaffoldColor.withOpacity(opacity);
  }

  Color textColor(double opacity) {
    return this._textColor.withOpacity(opacity);
  }

  Color buttonColor(double opacity) {
    return this._buttonColor.withOpacity(opacity);
  }
